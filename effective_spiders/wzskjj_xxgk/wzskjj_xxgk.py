...
class Wzskjj_xxgkSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        yield Request(first_page, callback=self.datail_page, method="post", headers={"Content-Type":"application/x-www-form-urlencoded"},
    ...
    def datail_page(self, response):
        ...
        for num in range(1,total_page+1):
            ...
            yield Request(next_page,  method="post", headers={"Content-Type":"application/x-www-form-urlencoded"},
                      body="infotypeId=&jdid=2497&area=001008003015006&divid=div1326694&vc_title=&vc_number=&currpage=2&vc_filenumber=&vc_all=&texttype=&fbtime=&texttype=&fbtime=&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage={}&sortfield=".format(num))
