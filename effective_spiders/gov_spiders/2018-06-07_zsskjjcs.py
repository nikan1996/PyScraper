...
class zsskjjcsSpider(Spider):
    name = 'zsskjjcs'
    allowed_domains = ['zskjj.zhoushan.gov.cn']
    start_urls = ['http://zskjj.zhoushan.gov.cn/']
    rules = [
    ('市科技局2017', '市科技局2016'),
    ('舟山', '*山'),
    ]
